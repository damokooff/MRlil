...
export const botConfig = {
  ...
  applications: {
    ...
    defaultQuestions: [
      ...
      { question: "Pourquoi veux-tu nous rejoindre ?", required: true },
    ],
  ...
  verification: {
    ...
    autoVerify: {
      ...
      criteria: {
        account_age: "Le compte doit être plus âgé que le nombre de jours spécifié",
  ...
  counters: {
    ...
    types: {
      ...
      bots: {
        name: "🤖 Bots",
        description: "Nombre total de bots sur le serveur",
        getCount: (guild) =>
